...
class InstanceAttemptAnswer(models.Model):
    ...
    question_id = models.ForeignKey('question.Question', related_name='questions_answer', on_delete=models.CASCADE, verbose_name=_('Question'))
    option_id = models.ForeignKey('question.Option', related_name='options_answer', on_delete=models.CASCADE, verbose_name=_('Option'))
