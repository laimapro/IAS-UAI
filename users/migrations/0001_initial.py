# Generated by Django 4.2.4 on 2024-01-14 13:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('COMPANY', 'Company'), ('COORDINATOR', 'Coordinator'), ('PATICIPANT', 'Participant'), ('STAFF', 'Staff')], default='PATICIPANT', max_length=50, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('profile_manager', models.CharField(default='', max_length=255, verbose_name='Profile Manager')),
                ('social_name', models.CharField(blank=True, max_length=125, null=True, verbose_name='Social Name')),
                ('title_pronoun', models.CharField(blank=True, max_length=45, null=True, verbose_name='Title and Pronoun')),
                ('phone_manager', models.CharField(default='', max_length=20, verbose_name='Phone Manager')),
                ('email_manager', models.EmailField(default='', max_length=255, verbose_name='Email Manager')),
